            ...
            <div class="flex flex-col">
                <div class=" overflow-x-auto">
                    <div class="min-w-full inline-block align-middle">
                                    ...
                                    @foreach ($personattributes as $personattribute)
                                        <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                                            ...
                                            <td
                                                ...
                                                {{ $personattribute->genderLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->age }} Tahun
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ number_format($personattribute->height * 100, 0) }} Cm
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ number_format($personattribute->weight, 0) }} Kg
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->familyhistoryLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->favcLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->fcvcLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->ncpLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->caecLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->smokeLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->ch2oLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->sccLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->fafLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->tueLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->calcLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->mtransLabel }}
                                            </td>
                                            <td
                                                class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                                {{ $personattribute->nobeyesdad }}
                                            </td>
                                            <td class="p-5">
                        ...
                        @include('paginationdataset', ['personattributes' => $personattributes])
